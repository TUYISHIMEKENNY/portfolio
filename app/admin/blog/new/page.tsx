...
export default function NewBlogPostPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const postToSave = {
        ...postData,
        imagePath: imagePath || postData.imagePath,
        tags,
        author: "Ngoma Benjamin", // Updated name
        ...
        readTime: `${Math.max(1, Math.ceil(postData.content.length / 1000))} min read`,
        status: "published",
      }
    ...
    <div className="container mx-auto px-4 py-12 md:px-6 md:py-20">
      <div className="mx-auto max-w-4xl">
        ...
        <div className="mb-8 text-center" data-aos="fade-up">
          <h1 className="text-3xl font-bold tracking-tighter sm:text-4xl">Create New Blog Post</h1>
          <p className="mt-2 text-muted-foreground">Share your knowledge and insights with the world</p>
        </div>
