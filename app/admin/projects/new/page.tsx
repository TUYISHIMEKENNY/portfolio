...
export default function NewProjectPage() {
  ...
  const [projectData, setProjectData] = useState({
    ...
    githubUrl: "",
    featured: false,
    status: "published", // Add this line with default value
  })
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const projectToSave = {
        ...projectData,
        imagePath: imagePath || projectData.imagePath,
        technologies: tags,
    ...
    <div className="container mx-auto px-4 py-12 md:px-6 md:py-20">
      <div className="mx-auto max-w-3xl">
        ...
        <div className="mb-8 text-center" data-aos="fade-up">
          <h1 className="text-3xl font-bold tracking-tighter sm:text-4xl">Add New Project</h1>
          <p className="mt-2 text-muted-foreground">Create a new project to showcase in your portfolio</p>
        </div>
